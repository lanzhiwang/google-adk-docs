...
try:
    ...
    print(
        f"❌ Could not redefine Greeting agent. Check Model/API Key ({greeting_agent.model}). Error: {e}"
    )
...
try:
    ...
    print(
        f"❌ Could not redefine Farewell agent. Check Model/API Key ({farewell_agent.model}). Error: {e}"
    )
